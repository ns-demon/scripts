...
game.StarterGui:SetCore("SendNotification", {
    ...
    Button1 = "Add qrcode1 on dc";
})

local Window = Library:Create("Kevins's ware","Any game like da hood")
local Tab1 = Window:Tab("Aimlocks",true)

Tab1:Label("Aimlock")

Tab1:Button("Kevin's Aimlock",function(bool)
    getgenv().AimPart = "Head"
	getgenv().AimlockKey = "q"
	getgenv().AimRadius = 22
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Kevin's ware";
    Text = "Welcome homies add qrcode1 on discord";
    Icon = "RBXID OR BLANK";
    Duration = "DURATION IN SECONDS";
    callback = bindableFunction; --callbakc
    Button1 = "Okay";
})

Tab3:Button("Realistic Speed Glitch (wallet only) (V)",function(bool)
...
Tab3:Button("FLY (is broken rn)",function(bool)
    loadstring(game:HttpGet("loadstring(game:HttpGet("https://raw.githubusercontent.com/ns-demon/scripts/refs/heads/main/fly.lua"))()"))()
end)
...
local Tab4 = Window:Tab(" Bad Anti-Lock",false)

Tab4:Label(" Trash Anti-Lock")

Tab4:Button("FIX  (dont work)ANTILOCK",function(bool)
...
Tab4:Button("Antilock Improved (Trash) (Z)",function(bool)
...
local Tab5 = Window:Tab("Teleports only works in real da hood",false)

Tab5:Label("Teleports only works in real da hood")
